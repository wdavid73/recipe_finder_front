...
ThemeData getApplicationDarkTheme({bool isDark = true}) {
  return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        suffixIconColor:
            isDark ? Colors.white : ColorManager.backgroundDarkColor,
      ...
      datePickerTheme: DatePickerThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          hintStyle: getRegularStyle(
            color:
                isDark ? ColorManager.textSecondary : ColorManager.textPrimary,
          ),
          labelStyle: getMediumStyle(
            color:
                isDark ? ColorManager.textSecondary : ColorManager.textPrimary,
      ...
      bottomSheetTheme: BottomSheetThemeData(
        ...
        dragHandleColor:
            isDark ? Colors.white : ColorManager.backgroundDarkColor,
        surfaceTintColor:
            isDark ? ColorManager.containerColorDark : Colors.white,
      ),
      ...
      checkboxTheme: CheckboxThemeData(
        ...
        side: BorderSide(
          color: isDark ? Colors.white : ColorManager.accentColor,
          width: 2,
        ),
